...
const Branch branches[NUM_BRANCHES] =
{
    ...
    { BRANCH_TEMPLE, BRANCH_DUNGEON, 8, 8, 1, 5,
      BFLAG_NO_ITEMS,
    ...
    { BRANCH_ORC, BRANCH_DUNGEON, 3, 4, 1, 8,
      BFLAG_SPOTTY,
    ...
    { BRANCH_LAIR, BRANCH_DUNGEON, 2, 2, 1, 10,
      BFLAG_NONE,
    ...
    { BRANCH_SWAMP, BRANCH_LAIR, 1, 1, 2, 15,
    ...
    { BRANCH_SHOALS, BRANCH_LAIR, 1, 1, 2, 15,
      BFLAG_DANGEROUS_END,
    ...
    { BRANCH_SNAKE, BRANCH_LAIR, 1, 1, 2, 15,
      BFLAG_DANGEROUS_END,
    ...
    { BRANCH_SPIDER, BRANCH_LAIR, 1, 1, 2, 15,
      BFLAG_DANGEROUS_END,
    ...
    { BRANCH_SLIME, BRANCH_LAIR, 1, 1, 2, 17,
    ...
    { BRANCH_VAULTS, BRANCH_DUNGEON, 4, 5, 2, 19,
      BFLAG_DANGEROUS_END,
